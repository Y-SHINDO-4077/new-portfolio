		...
		<div className="dark:bg-darkBaige">
			...
			<section className="flex items-center justify-start">
				<ul className="relative left-[1.5rem] top-0 border-l-2 border-solid border-black dark:border-white">
					<li className="relative w-[calc(100%_-_40px)] py-[1.5rem] pl-[1.5rem] text-3xl font-bold before:absolute before:left-[-0.75rem] before:top-8 before:size-[20px] before:rounded-3xl before:bg-black dark:before:bg-white md:left-[4rem] md:w-full md:pl-[3rem] md:before:left-[-4.75rem]">
