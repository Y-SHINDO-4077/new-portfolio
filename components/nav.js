...
export default function Nav() {
	...
	return (
		...
		>
			...
			<ul className="fixed inset-[0_-100%] z-[-1] grid  place-content-center  gap-8 bg-black/60 text-center transition-transform duration-300 ease-out md:static md:mr-8 md:flex md:gap-10  md:bg-inherit">
				<li>
					<Link
						href="/me/"
