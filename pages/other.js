...
export default function OTHER({ posts }) {
	return (
		<>
			...
			<DNUSetion />
			<div className="overflow-x-hidden dark:bg-[#2C2C30]">
				<PolicySetion
					title="What’s DNU?"
  ...
  「ナゴヤ(東海三県)のまちがまるごとキャンパス」を謳い、学びの場を提供するNPO。毎月第二土曜日に「大ナゴヤの日」を開催したり、「歩くまちには何がある？」というコンセプトを掲げた「まちシル」など、さまざまな活動を行っている。"
					className="dark:bg-darkBaige dark:text-white"
				/>
				...
				<Container>
					<div className="ml-auto mt-6 flex w-fit justify-end ">
						...
						>
							<span className="text-3xl dark:text-white md:text-6xl">HPはこちら</span>
						</Link>
					</div>
				</Container>
				...
				<Container className="dark:bg-darkBaige">
					<DNUTimeline />
				</Container>
			</div>
		</>
