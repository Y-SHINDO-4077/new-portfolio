...
import { DOT_NEXT_ALIAS, PAGES_DIR_ALIAS, ROOT_DIR_ALIAS, APP_DIR_ALIAS, SERVER_RUNTIME, WEBPACK_LAYERS, RSC_MOD_REF_PROXY_ALIAS } from "../lib/constants";
...
export function getDefineEnv({ dev , config , distDir , isClient , hasRewrites , isNodeServer , isEdgeServer , middlewareMatchers  }) {
    ...
    return {
        ...
        "process.env.__NEXT_MANUAL_TRAILING_SLASH": JSON.stringify((ref3 = config.experimental) == null ? void 0 : ref3.skipTrailingSlashRedirect),
...
export function attachReactRefresh(webpackConfig, targetLoader) {
    ...
    (ref = webpackConfig.module) == null ? void 0 : (ref4 = ref.rules) == null ? void 0 : ref4.forEach((rule)=>{
...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers , noMangling =false  }) {
    var ref46, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, // allows add JsConfigPathsPlugin to allow hot-reloading
    ...
    if (useSWCLoader) {
        ...
        const binaryTarget = (ref27 = require("./swc")) == null ? void 0 : ref27.getBinaryMetadata == null ? void 0 : (ref28 = ref27.getBinaryMetadata()) == null ? void 0 : ref28.target;
    ...
    const getSwcLoader = (extraOptions)=>{
        ...
        if ((config == null ? void 0 : (ref = config.experimental) == null ? void 0 : ref.swcTraceProfiling) && !swcTraceProfilingInitialized) {
            ...
            (ref45 = require("./swc")) == null ? void 0 : ref45.initCustomTraceSubscriber == null ? void 0 : ref45.initCustomTraceSubscriber(path.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return {
    ...
    const looseEsmExternals = ((ref46 = config.experimental) == null ? void 0 : ref46.esmExternals) === "loose";
    ...
    async function handleExternals(context, request, dependencyType, layer, getResolve) {
        ...
        const shouldBeBundled = isResourceInPackages(res, config.experimental.transpilePackages, resolvedExternalPackageDirs) || isEsm && config.experimental.appDir;
    ...
    let webpackConfig = {
                    ...
                    new TerserPlugin({
                        ...
                        terserOptions: {
                            ...
                            mangle: {
                                ...
                                ...((ref47 = config.experimental.swcMinifyDebugOptions) == null ? void 0 : ref47.mangle) ?? {}
                            }
                        }
                    }).apply(compiler);
                },
        ...
        plugins: [
            ...
            isEdgeServer && new MiddlewarePlugin({
                dev,
                sriEnabled: !dev && !!((ref5 = config.experimental.sri) == null ? void 0 : ref5.algorithm),
            ...
            !dev && isClient && !!((ref6 = config.experimental.sri) == null ? void 0 : ref6.algorithm) && new SubresourceIntegrityPlugin(config.experimental.sri.algorithm),
            ...
            !dev && isClient && new (require("./webpack/plugins/telemetry-plugin")).TelemetryPlugin(new Map([
                ...
                [
                    "swcRelay",
                    !!((ref7 = config.compiler) == null ? void 0 : ref7.relay)
                ],
                [
                    "swcStyledComponents",
                    !!((ref8 = config.compiler) == null ? void 0 : ref8.styledComponents)
                ],
                [
                    "swcReactRemoveProperties",
                    !!((ref9 = config.compiler) == null ? void 0 : ref9.reactRemoveProperties), 
                ],
                [
                    "swcExperimentalDecorators",
                    !!(jsConfig == null ? void 0 : (ref10 = jsConfig.compilerOptions) == null ? void 0 : ref10.experimentalDecorators), 
                ],
                [
                    "swcRemoveConsole",
                    !!((ref11 = config.compiler) == null ? void 0 : ref11.removeConsole)
                ],
                [
                    "swcImportSource",
                    !!(jsConfig == null ? void 0 : (ref12 = jsConfig.compilerOptions) == null ? void 0 : ref12.jsxImportSource)
                ],
                [
                    "swcEmotion",
                    !!((ref13 = config.compiler) == null ? void 0 : ref13.emotion)
                ],
                [
                    "turbotrace",
    ...
    if (resolvedBaseUrl) {
        var ref29, ref30;
        (ref29 = webpackConfig.resolve) == null ? void 0 : (ref30 = ref29.modules) == null ? void 0 : ref30.push(resolvedBaseUrl);
    }
    (ref14 = webpackConfig.resolve) == null ? void 0 : (ref15 = ref14.plugins) == null ? void 0 : ref15.unshift(new JsConfigPathsPlugin((jsConfig == null ? void 0 : (ref16 = jsConfig.compilerOptions) == null ? void 0 : ref16.paths) || {}, resolvedBaseUrl || dir));
    const webpack5Config = webpackConfig;
    if (isEdgeServer) {
        var ref31, ref32, ref33, ref34, ref35, ref36;
        ...
        (ref35 = webpack5Config.module) == null ? void 0 : (ref36 = ref35.rules) == null ? void 0 : ref36.unshift({
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref17 = config.compiler) == null ? void 0 : ref17.removeConsole,
        reactRemoveProperties: (ref18 = config.compiler) == null ? void 0 : ref18.reactRemoveProperties,
        styledComponents: (ref19 = config.compiler) == null ? void 0 : ref19.styledComponents,
        relay: (ref20 = config.compiler) == null ? void 0 : ref20.relay,
        emotion: (ref21 = config.compiler) == null ? void 0 : ref21.emotion,
        modularizeImports: (ref22 = config.experimental) == null ? void 0 : ref22.modularizeImports,
        legacyBrowsers: (ref23 = config.experimental) == null ? void 0 : ref23.legacyBrowsers,
    ...
    const cache = {
        ...
        version: `${"13.0.7-canary.3"}|${configVars}`,
    ...
    if (typeof config.webpack === "function") {
        ...
        if (((ref37 = webpack5Config.experiments) == null ? void 0 : ref37.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref38 = webpack5Config.experiments) == null ? void 0 : ref38.lazyCompilation) === "object" && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref39;
        const rules = ((ref39 = webpackConfig.module) == null ? void 0 : ref39.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref24 = webpackConfig.module) == null ? void 0 : ref24.rules) && webpackConfig.plugins) {
    ...
    const hasUserCssConfig = ((ref25 = webpackConfig.module) == null ? void 0 : (ref26 = ref25.rules) == null ? void 0 : ref26.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) ?? false;
    if (hasUserCssConfig) {
        var ref40, ref41, ref42, ref43, ref44;
        ...
        if ((ref40 = webpackConfig.module) == null ? void 0 : (ref41 = ref40.rules) == null ? void 0 : ref41.length) {
        ...
        if ((ref42 = webpackConfig.plugins) == null ? void 0 : ref42.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true);
        }
        if ((ref43 = webpackConfig.optimization) == null ? void 0 : (ref44 = ref43.minimizer) == null ? void 0 : ref44.length) {
