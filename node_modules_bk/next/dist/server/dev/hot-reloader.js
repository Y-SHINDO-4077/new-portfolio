...
class HotReloader {
    ...
    async start() {
        ...
        const trackPageChanges = (pageHashMap, changedItems, serverComponentChangeCallback)=>{
            return (stats)=>{
                try {
        ...
        this.multiCompiler.compilers[1].hooks.emit.tap("NextjsHotReloaderForServer", trackPageChanges(prevServerPageHashes, changedServerPages, (key)=>changedServerComponentPages.add(key)));
        this.multiCompiler.compilers[2].hooks.emit.tap("NextjsHotReloaderForServer", trackPageChanges(prevEdgeServerPageHashes, changedEdgeServerPages, (key)=>changedServerComponentPages.add(key)));
