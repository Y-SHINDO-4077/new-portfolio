...
import { getLocationOrigin, getURL, loadGetInitialProps, normalizeRepeatedSlashes, ST, isAbsoluteUrl } from '../utils';
    ...
    change(method, url, as, options, forcedScroll) {
        ...
        return _async_to_generator(function*() {
            ...
            try {
                ...
                const canSkipUpdating = options._h && !upcomingScrollState && !readyStateChange && !localeChange && compareRouterStates(upcomingRouterState, _this.state);
                if (!canSkipUpdating) {
